-- Migration: Create get_supply_costs RPC function
-- Description: Mirrors get_plant_costs but aggregates from userproducts table
-- Returns monthly, quarterly, and yearly supply costs for a given user
...
-- Grant permissions to match get_plant_costs
