...
REM Usage: build.bat [dev|prod|playstore]

set ENVIRONMENT=%1
if "%ENVIRONMENT%"=="" set ENVIRONMENT=dev

if "%ENVIRONMENT%"=="playstore" goto playstore
if "%ENVIRONMENT%"=="prod" goto prod
goto dev
...
flutter build appbundle --release ^
    ...
    --dart-define=REVENUE_CAT_ANDROID_API_KEY=goog_YcTwAxdzBQCTTogBgSirpzebWdV ^
