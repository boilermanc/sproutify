...
class IndoorOutdoorNewWidget extends StatefulWidget {
  const IndoorOutdoorNewWidget({
    super.key,
...
class _IndoorOutdoorNewWidgetState extends State<IndoorOutdoorNewWidget> {
  late IndoorOutdoorNewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IndoorOutdoorNewModel());
