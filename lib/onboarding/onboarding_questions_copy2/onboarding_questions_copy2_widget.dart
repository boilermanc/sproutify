...
import 'onboarding_questions_copy2_model.dart';
export 'onboarding_questions_copy2_model.dart';

class OnboardingQuestionsCopy2Widget extends StatefulWidget {
  const OnboardingQuestionsCopy2Widget({super.key});

  static String routeName = 'onboardingQuestionsCopy2';
  static String routePath = '/onboardingQuestionsCopy2';

  @override
  State<OnboardingQuestionsCopy2Widget> createState() =>
      _OnboardingQuestionsCopy2WidgetState();
}

class _OnboardingQuestionsCopy2WidgetState
    extends State<OnboardingQuestionsCopy2Widget>
    with TickerProviderStateMixin {
  late OnboardingQuestionsCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OnboardingQuestionsCopy2Model());
                            ...
                            children: [
                              FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  ...
                                  context.pushNamed(
                                    Settings1AddProfileWidget.routeName,
                                    queryParameters: {
                                              ...
                                              Padding(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    Flexible(
                                                      child: Text(
                                                        'Leafy Greens (e.g., Lettuce, Arugula, Kale)',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .bodyLarge
