...
import 'pesticide_detail_model.dart';
export 'pesticide_detail_model.dart';

class PesticideDetailWidget extends StatefulWidget {
  const PesticideDetailWidget({super.key});

  static String routeName = 'pesticideDetail';
  static String routePath = '/pesticideDetail';

  @override
  State<PesticideDetailWidget> createState() => _PesticideDetailWidgetState();
}

class _PesticideDetailWidgetState extends State<PesticideDetailWidget> {
  late PesticideDetailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PesticideDetailModel());
                                    ...
                                    Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          ...
                                          await launchURL(listViewPestContentRow
                                              .contentResourceUrl!);
                                        },
                                        child: Text(
