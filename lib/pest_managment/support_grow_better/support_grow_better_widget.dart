...
import 'support_grow_better_model.dart';
...
class SupportGrowBetterWidget extends StatefulWidget {
  ...
  static String routeName = 'supportGrowBetter';
  static String routePath = '/supportGrowBetter';
...
class _SupportGrowBetterWidgetState extends State<SupportGrowBetterWidget>
    with TickerProviderStateMixin {
  late SupportGrowBetterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SupportGrowBetterModel());
