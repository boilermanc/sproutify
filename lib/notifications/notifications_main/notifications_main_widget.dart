...
import 'notifications_main_model.dart';
export 'notifications_main_model.dart';
...
class _NotificationsMainWidgetState extends State<NotificationsMainWidget> {
  late NotificationsMainModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NotificationsMainModel());
