...
class MainFAQWidget extends StatefulWidget {
  ...
  static String routeName = 'mainFAQ';
  static String routePath = '/mainFAQ';
...
class _MainFAQWidgetState extends State<MainFAQWidget>
  ...
  void initState() {
    ...
    _model.faqSearchFieldTextController ??= TextEditingController();
                  ...
                  child: Padding(
                    ...
                    child: TextFormField(
                      ...
                      onFieldSubmitted: (_) async {
                        context.pushNamed(
                          FaqSearchResultsWidget.routeName,
                          queryParameters: {
                            'searchTerm': serializeParam(
                              _model.faqSearchFieldTextController.text,
                              ParamType.String,
                            ),
                          }.withoutNulls,
                        );
                      ...
                      decoration: InputDecoration(
                        ...
                        suffixIcon: _model
                                .faqSearchFieldTextController!.text.isNotEmpty
                            ? InkWell(
                                onTap: () async {
                      ...
                      validator: _model.faqSearchFieldTextControllerValidator
                          .asValidator(context),
                      inputFormatters: [
                        if (!isAndroid && !isiOS)
