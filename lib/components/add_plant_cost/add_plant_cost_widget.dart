...
class _AddPlantCostWidgetState extends State<AddPlantCostWidget> {
  ...
  void initState() {
    ...
    _model.plantCostTextController ??= TextEditingController();
          ...
          child: Container(
            ...
            child: FutureBuilder<List<UserplantsRow>>(
              ...
              builder: (context, snapshot) {
                ...
                final listViewUserplantsRow =
                    listViewUserplantsRowList.isNotEmpty
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  await UserplantsTable().update(
                                    data: {
                                      'plant_cost': double.tryParse(
                                          _model.plantCostTextController.text),
                                    },
                                  ...
                                  safeSetState(() {
                                    _model.plantCostTextController?.clear();
                                  });
