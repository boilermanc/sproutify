...
class _AddYourProductWidgetState extends State<AddYourProductWidget> {
  ...
  void initState() {
    ...
    _model.enterCostTextController ??= TextEditingController();
                                ...
                                child: TextFormField(
                                  ...
                                  keyboardType:
                                      const TextInputType.numberWithOptions(
                                          decimal: true),
                                  validator: _model
                                      .enterCostTextControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.enterQuantityTextController,
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              await UserproductsTable().insert({
                                'userpurchasecost': double.tryParse(
                                    _model.enterCostTextController.text),
                                'userpurchasedquantity': int.tryParse(
                                    _model.enterQuantityTextController.text),
                                'productid': listViewProductsRow?.productid,
                                'userid': currentUserUid,
                                'userpurchasedate': supaSerialize<DateTime>(
                                    getCurrentTimestamp),
                              });
                              safeSetState(
