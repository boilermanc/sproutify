...
class PlantCatalogCopyWidget extends StatefulWidget {
  ...
  static String routeName = 'plantCatalogCopy';
  static String routePath = '/plantCatalogCopy';
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final plantCatalogCopyPlantCatalogSearchResponse = snapshot.data!;
                                    ...
                                    child: Padding(
                                      ...
                                      child: Autocomplete<String>(
                                        ...
                                        optionsBuilder: (textEditingValue) {
                                          ...
                                          return (getJsonField(
                                            plantCatalogCopyPlantCatalogSearchResponse
                                                .jsonBody,
                                            r'''$.plant_name''',
                                            true,
                                          ) as List?)!
