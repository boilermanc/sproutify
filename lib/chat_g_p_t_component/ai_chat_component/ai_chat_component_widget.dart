...
class _AiChatComponentWidgetState extends State<AiChatComponentWidget> {
  ...
  void initState() {
    ...
    _model.chatInputFieldTextController ??= TextEditingController();
    _model.chatInputFieldFocusNode ??= FocusNode();
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: TextFormField(
                        ...
                        validator: _model.chatInputFieldTextControllerValidator
                            .asValidator(context),
                        inputFormatters: [
                          if (!isAndroid && !isiOS)
                    ...
                    Align(
                      ...
                      child: FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          ...
                          _model.chatGPTResponse = await NeightnMainChatGroup
                              .sendFullPromptCall
                              .call(
                            userMessage:
                                _model.chatInputFieldTextController.text,
                          ...
                          if ((_model.chatGPTResponse?.succeeded ?? true)) {
                            ...
                            safeSetState(() {});
                            safeSetState(() {
                              _model.chatInputFieldTextController?.clear();
                            });
                          } else {
