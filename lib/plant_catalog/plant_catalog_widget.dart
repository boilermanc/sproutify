...
class PlantCatalogWidget extends StatefulWidget {
  const PlantCatalogWidget({Key? key}) : super(key: key);

  @override
  _PlantCatalogWidgetState createState() => _PlantCatalogWidgetState();
}
                  ...
                  child: Padding(
                    ...
                    child: FutureBuilder<List<PlantsRow>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<PlantsRow> gridViewPlantsRowList = snapshot.data!;
                                  ...
                                  context.pushNamed(
                                    ...
                                    queryParameters: {
                                      'plantID': serializeParam(
                                        gridViewPlantsRow.plantId,
                                        ParamType.int,
                                      ),
                                      'plantName': serializeParam(
                                        gridViewPlantsRow.plantName,
                                        ParamType.String,
                                      ),
                                      'isFavorite': serializeParam(
                                        FFAppState().isplantFavorite,
                                        ParamType.bool,
                                      ),
                                    }.withoutNulls,
                                  );
