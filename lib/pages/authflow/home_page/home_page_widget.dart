                      ...
                      children: [
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 0.0, 10.0, 0.0),
                          child: FutureBuilder<List<UserNotificationsReadRow>>(
                            future: UserNotificationsReadTable().querySingleRow(
                              queryFn: (q) => q,
                            ),
                            builder: (context, snapshot) {
                              ...
                              List<UserNotificationsReadRow>
                                  notificationBellUserNotificationsReadRowList =
                                  snapshot.data!;
                              final notificationBellUserNotificationsReadRow =
                                  notificationBellUserNotificationsReadRowList
                                          .isNotEmpty
                                      ? notificationBellUserNotificationsReadRowList
                                          .first
              ...
              children: [
                            ...
                            children: [
                                ...
                                child: Container(
                                  ...
                                  child: FutureBuilder<List<UserplantsRow>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      List<UserplantsRow>
                                          myPlantUserplantsRowList =
                                          snapshot.data!;
                                      final myPlantUserplantsRow =
                                          myPlantUserplantsRowList.isNotEmpty
                                              ? myPlantUserplantsRowList.first
                                              : null;
                                      return InkWell(
                                        splashColor: Colors.transparent,
                                        focusColor: Colors.transparent,
                              ...
                              Expanded(
                                child: Container(
                                  width: 71.0,
                                  decoration: BoxDecoration(),
                                  child: FutureBuilder<List<MyTowersRow>>(
                                    future: MyTowersTable().querySingleRow(
                                      queryFn: (q) => q,
                                    ),
                                    builder: (context, snapshot) {
                                      // Customize what your widget looks like when it's loading.
                                      ...
                                      List<MyTowersRow>
                                          myTowersMyTowersRowList =
                                          snapshot.data!;
                                      final myTowersMyTowersRow =
                                          myTowersMyTowersRowList.isNotEmpty
                                              ? myTowersMyTowersRowList.first
                                              : null;
                                      return InkWell(
                                        splashColor: Colors.transparent,
                                        focusColor: Colors.transparent,
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child:
                        FutureBuilder<List<GardeningInspirationalMessagesRow>>(
                      future:
                          GardeningInspirationalMessagesTable().querySingleRow(
                        queryFn: (q) => q.eq(
                          'message_date',
                              ...
                              Padding(
                                ...
                                child: FutureBuilder<List<MyTowersRow>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<MyTowersRow>
                                        logoutButtonMyTowersRowList =
                                        snapshot.data!;
                                    final logoutButtonMyTowersRow =
                                        logoutButtonMyTowersRowList.isNotEmpty
                                            ? logoutButtonMyTowersRowList.first
                                            : null;
