...
import 'worms_detail_model.dart';
export 'worms_detail_model.dart';

class WormsDetailWidget extends StatefulWidget {
  const WormsDetailWidget({super.key});

  @override
  State<WormsDetailWidget> createState() => _WormsDetailWidgetState();
}

class _WormsDetailWidgetState extends State<WormsDetailWidget>
    with TickerProviderStateMixin {
  late WormsDetailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WormsDetailModel());
