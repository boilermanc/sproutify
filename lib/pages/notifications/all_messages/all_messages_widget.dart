              ...
              child: Stack(
                children: [
                  ...
                  Align(
                    ...
                    child: FutureBuilder<List<AllUnreadNotificationsRow>>(
                      future: AllUnreadNotificationsTable().querySingleRow(
                        queryFn: (q) => q.eq(
                          'user_id',
                          currentUserUid,
                        ),
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<AllUnreadNotificationsRow>
                            notificationAlertAllUnreadNotificationsRowList =
                            snapshot.data!;
                        // Return an empty Container when the item does not exist.
                        if (snapshot.data!.isEmpty) {
                          return Container();
                        }
                        final notificationAlertAllUnreadNotificationsRow =
                            notificationAlertAllUnreadNotificationsRowList
                                    .isNotEmpty
                                ? notificationAlertAllUnreadNotificationsRowList
                                    .first
