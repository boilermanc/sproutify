                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: FlutterFlowDropDown<String>(
                      controller: _model.plantRatingValueController ??=
                          FormFieldController<String>(null),
                      options: ['5', '4', '3', '2', '1'],
                      onChanged: (val) =>
                          setState(() => _model.plantRatingValue = val),
                      width: 300.0,
                      height: 50.0,
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          _model.apiResultvkw = await UpsertRatingsCall.call(
                            plantID: widget.plantID,
                            userID: widget.userID,
                            rating: (int.parse((_model.plantRatingValue!)))
                                .toDouble(),
                            userPlantID: widget.userPlantID,
                          );
                          if ((_model.apiResultvkw?.succeeded ?? true)) {
