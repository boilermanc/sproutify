...
class SproutifyPurchasePageWidget extends StatefulWidget {
  const SproutifyPurchasePageWidget({super.key});

  static String routeName = 'sproutifyPurchasePage';
  static String routePath = '/sproutifyPurchasePage';

  @override
  State<SproutifyPurchasePageWidget> createState() =>
      _SproutifyPurchasePageWidgetState();
}

class _SproutifyPurchasePageWidgetState
    extends State<SproutifyPurchasePageWidget> {
  late SproutifyPurchasePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SproutifyPurchasePageModel());
