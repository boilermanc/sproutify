...
class PlantDetail3Widget extends StatefulWidget {
  const PlantDetail3Widget({
    super.key,
  ...
  static String routeName = 'plantDetail3';
  static String routePath = '/plantDetail3';

  @override
  State<PlantDetail3Widget> createState() => _PlantDetail3WidgetState();
}

class _PlantDetail3WidgetState extends State<PlantDetail3Widget> {
  late PlantDetail3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlantDetail3Model());
              ...
              children: [
                FutureBuilder<List<PlantsRow>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final listViewPlantsRow = listViewPlantsRowList.isNotEmpty
                        ? listViewPlantsRowList.first
                        : null;
