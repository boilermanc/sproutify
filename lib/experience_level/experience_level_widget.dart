...
class ExperienceLevelWidget extends StatefulWidget {
  const ExperienceLevelWidget({Key? key}) : super(key: key);
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              FutureBuilder<List<GardeningExperienceLevelsRow>>(
                future: GardeningExperienceLevelsTable().queryRows(
                  queryFn: (q) => q,
                ),
                builder: (context, snapshot) {
                  ...
                  List<GardeningExperienceLevelsRow>
                      radioButtonGardeningExperienceLevelsRowList =
                      snapshot.data!;
                  return FlutterFlowRadioButton(
                    options: radioButtonGardeningExperienceLevelsRowList
                        .map((e) => e.levelDescription)
                        .toList()
                        .toList(),
