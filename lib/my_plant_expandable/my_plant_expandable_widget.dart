...
import 'my_plant_expandable_model.dart';
export 'my_plant_expandable_model.dart';

class MyPlantExpandableWidget extends StatefulWidget {
  const MyPlantExpandableWidget({
    Key? key,
  ...
  @override
  _MyPlantExpandableWidgetState createState() =>
      _MyPlantExpandableWidgetState();
}

class _MyPlantExpandableWidgetState extends State<MyPlantExpandableWidget> {
  late MyPlantExpandableModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyPlantExpandableModel());
                                                ...
                                                return Builder(
                                                  builder: (context) {
                                                    if (valueOrDefault<bool>(
                                                      conditionalBuilderUserFavoritesRow
                                                          ?.isFavorite,
                                                      false,
                                                    )) {
